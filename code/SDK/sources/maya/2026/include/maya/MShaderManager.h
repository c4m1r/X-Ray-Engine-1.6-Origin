...
public:
    ...
    OPENMAYA_ENUM(MStockShader,
        ...
        k3dOpenPBRSurfaceShader, //!< An instance of an OpenPBR surface shader for 3d rendering
		OPENMAYA_AVAILABLE(2026)
		k3dIsotropicOpenPBRSurfaceShader, //!< An instance of an OpenPBR surface shader for 3d rendering, without anisotropy support and tangent geometry requirement.
