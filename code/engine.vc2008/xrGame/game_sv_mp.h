...
protected:
	...
	typedef xr_deque< u16 > CORPSE_LIST; typedef CORPSE_LIST::iterator CORPSE_LIST_it;

	CORPSE_LIST						m_CorpseList;

	typedef xr_vector< Rank_Struct > RANKS_LIST; typedef RANKS_LIST::iterator RANKS_LIST_it;
