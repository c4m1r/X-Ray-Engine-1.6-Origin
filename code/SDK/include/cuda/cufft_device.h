...
#define CUFFT_DEVICE_VER_MINOR 3
#define CUFFT_DEVICE_VER_PATCH 0

// CUFFT_DEVICE_VER_MAJOR * 1000 + CUFFT_DEVICE_VER_MINOR * 100 + CUFFT_DEVICE_VER_PATCH
#define CUFFT_DEVICE_VERSION 300
...
cufftResult CUFFTAPI cufftDeviceGetSemanticVersion(int* major, int* minor, int* patch);
