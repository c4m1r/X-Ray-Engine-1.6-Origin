...
#else
	typedef xr_vector< ref_sound > SoundVec; typedef SoundVec::iterator SoundIt;
	typedef xr_vector< shared_str > PSVec; typedef PSVec::iterator PSIt;
	typedef xr_vector< ref_shader > ShaderVec; typedef ShaderVec::iterator ShaderIt;
#endif
...
typedef xr_vector< SGameMtl* > GameMtlVec; typedef GameMtlVec::iterator GameMtlIt;
...
typedef xr_vector< SGameMtlPair* > GameMtlPairVec; typedef GameMtlPairVec::iterator GameMtlPairIt;
