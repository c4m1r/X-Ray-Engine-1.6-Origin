...
uses
  ...
  MxVCLUtils, MxMaxMin, Consts, MxAppUtils{$IFDEF RX_D4}, ImgList, // Polaris
  ActnList{$ENDIF}
  {$IFDEF RX_D6}, RTLConsts, Types{$ENDIF}; // Polaris
...
begin
  inherited Create(AOwner);
  //ShowMessage('TMxCustomLabel create');
