...
class PropItem
{
	...
	void*				item;
public:
	typedef xr_vector< PropValue* > PropValueVec; typedef PropValueVec::iterator PropValueIt;
private:
    PropValueVec		values;
    TProperties* 		m_Owner;
// events
...
#else */
	//#define smart_cast dynamic_cast // TODO: range fix?
