...
{
public:
	typedef xr_map<  const CEntity*,SSquadCommand > MEMBER_COMMAND_MAP; typedef MEMBER_COMMAND_MAP::iterator MEMBER_COMMAND_MAP_IT;
...
private:
	...
	typedef xr_vector<  const CEntityAlive* > CORPSES_VECTOR; typedef CORPSES_VECTOR::iterator CORPSES_VECTOR_IT;
