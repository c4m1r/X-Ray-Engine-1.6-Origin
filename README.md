...
8) TODO: 
 --- copy_lib_архитектура_конфигурация.cmd запускать как пост событие из студии! (xrEntry)!
 --- поправить батники: нужные новые dll (их взять из rad studio & visual studio)
