...
* \endinternal
*/
__CUDA_HOSTDEVICE_BF16_DECL__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16 __double2bfloat16(const double a);
/**
* \ingroup CUDA_MATH__BFLOAT16_MISC
...
public:
     ...
     */
    explicit __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(const __half f)
{
...
,
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(const float f) { __x = __float2bfloat16(f).__x; }
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Construct \p __nv_bfloat16 from \p double input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(const double f) { __x = __double2bfloat16(f).__x; }
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Type cast to \p float operator.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator float() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Type cast to \p __nv_bfloat16 assignment operator from \p float input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __nv_bfloat16 &operator=(const float f);
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __nv_bfloat16 &operator=(const double f);
 ...
 */
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(short val) { __x = __short2bfloat16_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Construct \p __nv_bfloat16 from \p unsigned \p short integer input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(unsigned short val) { __x = __ushort2bfloat16_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Construct \p __nv_bfloat16 from \p int input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(int val) { __x = __int2bfloat16_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Construct \p __nv_bfloat16 from \p unsigned \p int input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(unsigned int val) { __x = __uint2bfloat16_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Construct \p __nv_bfloat16 from \p long input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(const long val) {
...
#pragma warning (pop)
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(const unsigned long val) {
        /* Suppress VS warning: warning C4127: conditional expression is constant */
#if defined(_MSC_VER) && !defined(__CUDA_ARCH__)
#pragma warning (push)
#pragma warning (disable: 4127)
...
#pragma warning (pop)
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(long long val) { __x = __ll2bfloat16_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Construct \p __nv_bfloat16 from \p unsigned \p long \p long input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __nv_bfloat16(unsigned long long val) { __x = __ull2bfloat16_rn(val).__x; }
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator signed char() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator unsigned char() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator char() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator short() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator unsigned short() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator int() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator unsigned int() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Conversion operator to \p long data type.
     * Using round-toward-zero rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator long() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     * Conversion operator to \p unsigned \p long data type.
     * Using round-toward-zero rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator unsigned long() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator long long() const;
    /**
     * \ingroup CUDA_MATH__BFLOAT16_MISC
    ...
    * \ingroup CUDA_MATH__BFLOAT16_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator bool() const { return (__bfloat16_as_ushort(*this) & 0x7FFFU) != 0U; }
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_BF16_FORCEINLINE__ __NV_TL__ __nv_bfloat16 operator+(const __nv_bfloat16 &lh, const __nv_bfloat16 &rh);
/**
 * \ingroup CUDA_MATH__BFLOAT16_ARITHMETIC
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_BF16_FORCEINLINE__ __NV_TL__ __nv_bfloat16 &operator+=(__nv_bfloat16 &lh, const __nv_bfloat16 &rh);
/**
 * \ingroup CUDA_MATH__BFLOAT16_ARITHMETIC
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_BF16_FORCEINLINE__ __NV_TL__ __nv_bfloat16 &operator++(__nv_bfloat16 &h);
/**
 * \ingroup CUDA_MATH__BFLOAT16_ARITHMETIC
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_BF16_FORCEINLINE__ __NV_TL__ __nv_bfloat16 operator+(const __nv_bfloat16 &h);
/**
 * \ingroup CUDA_MATH__BFLOAT16_ARITHMETIC
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_BF16_FORCEINLINE__ __NV_TL__ bool operator==(const __nv_bfloat16 &lh, const __nv_bfloat16 &rh);
/**
 * \ingroup CUDA_MATH__BFLOAT16_COMPARISON
...
__CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__
