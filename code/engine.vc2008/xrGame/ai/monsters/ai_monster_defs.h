...
typedef xr_vector< SAAParam > AA_VECTOR; typedef AA_VECTOR::iterator AA_VECTOR_IT;
...
typedef xr_vector< SAnimItem* > ANIM_ITEM_VECTOR; typedef ANIM_ITEM_VECTOR::iterator ANIM_ITEM_VECTOR_IT;
typedef xr_vector< STransition > TRANSITION_ANIM_VECTOR; typedef TRANSITION_ANIM_VECTOR::iterator TRANSITION_ANIM_VECTOR_IT;
typedef xr_map< EAction,SMotionItem > MOTION_ITEM_MAP; typedef MOTION_ITEM_MAP::iterator MOTION_ITEM_MAP_IT;
typedef xr_vector< EMotionAnim > SEQ_VECTOR; typedef SEQ_VECTOR::iterator SEQ_VECTOR_IT;
typedef xr_vector< SAttackAnimation > ATTACK_ANIM; typedef ATTACK_ANIM::iterator ATTACK_ANIM_IT;
typedef xr_vector< SReplacedAnim > REPLACED_ANIM; typedef REPLACED_ANIM::iterator REPLACED_ANIM_IT;

typedef xr_map< u16,t_fx_index > FX_MAP_U16; typedef FX_MAP_U16::iterator FX_MAP_U16_IT;
typedef xr_map< shared_str,t_fx_index > FX_MAP_STRING; typedef FX_MAP_STRING::iterator FX_MAP_STRING_IT;


typedef xr_vector< SEQ_VECTOR > VELOCITY_CHAIN_VEC; typedef VELOCITY_CHAIN_VEC::iterator VELOCITY_CHAIN_VEC_IT;
...
typedef xr_map<  const CEntityAlive*,SMonsterEnemy > ENEMIES_MAP; typedef ENEMIES_MAP::iterator ENEMIES_MAP_IT;
...
typedef xr_map<  const CEntityAlive*,SMonsterCorpse > CORPSE_MAP; typedef CORPSE_MAP::iterator CORPSE_MAP_IT;
...
typedef xr_vector< SMonsterHit > MONSTER_HIT_VECTOR; typedef MONSTER_HIT_VECTOR::iterator MONSTER_HIT_VECTOR_IT;
...
typedef xr_map< MotionID,shared_str > ANIM_TO_MOTION_MAP; typedef ANIM_TO_MOTION_MAP::iterator ANIM_TO_MOTION_MAP_IT;
