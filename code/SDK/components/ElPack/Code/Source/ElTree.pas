...
type THackElList = class(TElList) // TElList
     end;
...
begin
  ...
  OutputDebugString(PChar(IntToStr(SizeOf(char)))); // range fix debug
...
begin
  ...
  FEditorsList := TElList.Create; //TElList.Create;
end;
