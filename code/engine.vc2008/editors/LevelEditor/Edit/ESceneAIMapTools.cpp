...
HANDLE ESceneAIMapTool::hMutex(NULL);
...
{
	// TODO: не ясно, на что влияет этот код - попробовать по-тестить, может найду
    // посмотреть время выполнения и какое число возвращает
	return 1;
//	int count = 0;
//	switch (LTools->GetSubTarget()){
//	case estAIMapNode:{
