...
protected:
	...
	typedef xr_deque< SMapRot > MAP_ROTATION_LIST; typedef MAP_ROTATION_LIST::iterator MAP_ROTATION_LIST_it;
	bool							m_bMapRotation;
...
#define		TEAM_COUNT 4
	...
	typedef xr_vector< RPoint* > RPRef; typedef RPRef::iterator RPRef_it;
