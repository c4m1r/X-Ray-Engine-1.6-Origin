...
typedef xr_vector< IBlender* > TemplateVec; typedef TemplateVec::iterator TemplateIt;
typedef xr_map< LPSTR,CConstant*, str_pred > ConstantMap; typedef ConstantMap::iterator ConstantPairIt;
typedef xr_map< LPSTR,CMatrix*, str_pred > MatrixMap; typedef MatrixMap::iterator MatrixPairIt;
typedef xr_map< LPSTR,IBlender*, str_pred > BlenderMap; typedef BlenderMap::iterator BlenderPairIt;
