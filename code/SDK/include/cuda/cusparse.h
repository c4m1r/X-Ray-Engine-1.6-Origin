...
CUSPARSE_DEPRECATED // deprecated in CTK 13.1
cusparseStatus_t CUSPARSEAPI
...
struct cusparseSpMVOpDescr;
typedef struct cusparseSpMVOpDescr* cusparseSpMVOpDescr_t;

struct cusparseSpMVOpPlan;
typedef struct cusparseSpMVOpPlan* cusparseSpMVOpPlan_t;
...
typedef CUSPARSE_DEPRECATED_TYPE_MSVC struct cusparseSpMMOpPlan*
    cusparseSpMMOpPlan_t CUSPARSE_DEPRECATED_TYPE;

typedef enum {
    CUSPARSE_SPMM_OP_ALG_DEFAULT
} cusparseSpMMOpAlg_t CUSPARSE_DEPRECATED_ENUM;
...
cusparseSpMMOp_createPlan(cusparseHandle_t          handle,
                          ...
                          const void*               addOperationLtoirBuffer,
                          size_t                    addOperationBufferSize,
                          const void*               mulOperationLtoirBuffer,
                          size_t                    mulOperationBufferSize,
                          const void*               epilogueLtoirBuffer,
