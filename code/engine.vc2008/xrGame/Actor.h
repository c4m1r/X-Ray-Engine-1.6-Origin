...
//	bool					m_bHasUpdate;	
...
#ifdef DEBUG
	typedef xr_deque< Fvector > VIS_POSITION; typedef VIS_POSITION::iterator VIS_POSITION_it;
	...
	//---------------------------------------------
	typedef xr_deque< SPHNetState > PH_STATES; typedef PH_STATES::iterator PH_STATES_it;
	PH_STATES				m_States;
	u16						m_u16NumBones;
