...
typedef xr_vector< st_WB > WBVec; typedef WBVec::iterator WBIt;
...
typedef xr_vector< st_VertexWB > VWBVec; typedef VWBVec::iterator VWBIt;
...
typedef xr_vector< st_VMapPtLst > VMRefsVec; typedef VMRefsVec::iterator VMRefsIt;
...
typedef xr_vector< IntVec > AdjVec; typedef AdjVec::iterator AdjIt;
typedef xr_vector< st_VMap* > VMapVec; typedef VMapVec::iterator VMapIt;
typedef xr_map< CSurface*,IntVec > SurfFaces; typedef SurfFaces::iterator SurfFacesPairIt;
...
public:
    ...
    static void SetDraftMeshMode(BOOL st);
...
public:
	                ...
	                //CEditableMesh			(CEditableMesh* source,CEditableObject* parent){m_Parent=parent;Construct();CloneFrom(source);} // range fix
    ...
    // mesh modify routine
	//void            CloneFrom				(CEditableMesh *source); // range fix
