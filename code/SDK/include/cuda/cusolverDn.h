...
extern "C" {
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnSetFixedPointEmulationMantissaControl(
    cusolverDnHandle_t handle,
    cudaEmulationMantissaControl_t control);

  cusolverStatus_t CUSOLVERAPI cusolverDnGetFixedPointEmulationMantissaControl(
    cusolverDnHandle_t handle,
    cudaEmulationMantissaControl_t* control);

  cusolverStatus_t CUSOLVERAPI cusolverDnSetFixedPointEmulationMaxMantissaBitCount(
    cusolverDnHandle_t handle,
    int mantissaBitCount);

  cusolverStatus_t CUSOLVERAPI cusolverDnGetFixedPointEmulationMaxMantissaBitCount(
    cusolverDnHandle_t handle,
    int* mantissaBitCount);

  cusolverStatus_t CUSOLVERAPI cusolverDnSetFixedPointEmulationMantissaBitOffset(
    cusolverDnHandle_t handle,
    int mantissaBitOffset);

  cusolverStatus_t CUSOLVERAPI cusolverDnGetFixedPointEmulationMantissaBitOffset(
    cusolverDnHandle_t handle,
    int* mantissaBitOffset);

  cusolverStatus_t CUSOLVERAPI cusolverDnSetEmulationSpecialValuesSupport(
    cusolverDnHandle_t handle,
    cudaEmulationSpecialValuesSupport_t mask);

  cusolverStatus_t CUSOLVERAPI cusolverDnGetEmulationSpecialValuesSupport(
    cusolverDnHandle_t handle,
    cudaEmulationSpecialValuesSupport_t* mask);
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnXsygvd_bufferSize(
    cusolverDnHandle_t handle,
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnXsygvd(
    cusolverDnHandle_t handle,
    cusolverDnParams_t params,
    cusolverEigType_t  itype,
    cusolverEigMode_t jobz,
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnXsygvdx_bufferSize(
    cusolverDnHandle_t handle,
    cusolverDnParams_t params,
    cusolverEigType_t  itype,
    cusolverEigMode_t jobz,
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnXsygvdx(
    cusolverDnHandle_t handle, 
    cusolverDnParams_t params, 
    cusolverEigType_t  itype,  
    cusolverEigMode_t jobz,    
 ...
 cusolverStatus_t CUSOLVERAPI cusolverDnXstedc_bufferSize(
    cusolverDnHandle_t handle,
    cusolverDnParams_t params,
 ...
 cusolverStatus_t CUSOLVERAPI cusolverDnXstedc(
    cusolverDnHandle_t handle,
    cusolverDnParams_t params,
    cusolverEigComp_t  compz,
    int64_t            n,
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnXpolar_bufferSize(
    cusolverDnHandle_t handle,
    cusolverDnParams_t params,
    cublasFillMode_t   uplo,
    int64_t            M,
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnXpolar(
    cusolverDnHandle_t handle,
    cusolverDnParams_t params,
    cublasFillMode_t   uplo,
    int64_t            M,
    ...
    void              *bufferOnHost,
    size_t             workspaceInBytesOnHost,
    double            *d_res_nrm,   /* [device] res = |A - Up*H| */
    double            *d_A_nrmF,    /* [device] A_nrmF = |A|_F */
    double            *d_rcond,     /* [device] rcond = 1/cond(A, 'fro') */
    int               *d_info       /* [device] */);
