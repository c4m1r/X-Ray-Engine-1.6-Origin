...
typedef xr_deque< cl_TeamStruct > CL_TEAM_DATA_LIST; typedef CL_TEAM_DATA_LIST::iterator CL_TEAM_DATA_LIST_it;
...
typedef xr_vector< cl_Message_Sound > TEAMSOUND; typedef TEAMSOUND::iterator TEAMSOUND_it;

struct cl_Menu_Message {
	shared_str		pMessage;	
	typedef xr_vector< TEAMSOUND > SOUND_VARIANTS; typedef SOUND_VARIANTS::iterator SOUND_VARIANTS_it;
...
struct cl_MessageMenu
{
	...
	typedef xr_vector< cl_Menu_Message > MENUMESSAGES; typedef MENUMESSAGES::iterator MENUMESSAGES_it;
...
protected:
	...
	typedef xr_vector< SND_Message* > SNDMESSAGES; typedef SNDMESSAGES::iterator SNDMESSAGES_it;
	SNDMESSAGES						m_pSndMessages;
	bool							m_bJustRestarted;
	typedef xr_vector< SND_Message* > SNDMESSAGESINPLAY; typedef SNDMESSAGESINPLAY::iterator SNDMESSAGESINPLAY_it;
	SNDMESSAGESINPLAY				m_pSndMessagesInPlay;

	typedef xr_vector< Bonus_Struct > BONUSES; typedef BONUSES::iterator BONUSES_it;
