...
public:
    ...
    int 				req_params;
    typedef xr_vector< Param > ParamVec; typedef ParamVec::iterator ParamIt;
    ParamVec			params;
...
typedef xr_map< AnsiString,PFunction > PFuncMap; typedef PFuncMap::iterator PFuncPairIt;
typedef xr_vector< PFunction > PFuncVec; typedef PFuncVec::iterator PFuncIt;
