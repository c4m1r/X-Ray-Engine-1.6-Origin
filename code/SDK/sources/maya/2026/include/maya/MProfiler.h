...
public:
    ...
    {
        kColorA_L1 = 0, // Pink
        kColorA_L2,     // Pink dark
        kColorA_L3,     // Pink light
        kColorB_L1,     // Green
        kColorB_L2,     // Green dark
        kColorB_L3,     // Green light
        kColorC_L1,     // Blue
        kColorC_L2,     // Blue dark
        kColorC_L3,     // Blue light
        kColorD_L1,     // Red-Orange
        kColorD_L2,     // Red-Orange dark
        kColorD_L3,     // Red-Orange light
        kColorE_L1,     // Yellow
        kColorE_L2,     // Yellow dark
        kColorE_L3,     // Yellow light
        kColorG_L1,     // Grey
        kColorG_L2,     // Grey dark
        kColorG_L3,     // Grey light
        kColorCount
    };
