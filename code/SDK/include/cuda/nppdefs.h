...
typedef enum /**< NppStatus NPP return value */
{
    ...
    NPP_LIBRARY_VERSION_MISMATCH_ERROR      = -9998,    /**< Application and NPP library version mismatch.*/
    ...
    NPP_WRONG_INTERSECTION_ROI_WARNING      = 29,       /**<  The given ROI has no intersection with either the source or destination ROI. Thus no operation was performed. */
...
typedef enum 
{
    ...
    NPP_WATERSHED_SEGMENT_BOUNDARIES_CONTRAST,  /**< Image watershed segment boundary type contrasting intensity. */
...
typedef enum
{
    NPP_TRANSCODE_ONLY, /**< no color space defined. used for simple transcoding. */
    NPP_BT601JPEG,      /**< BT601 colorspace used within JPEG images covering 0..255. */
    NPP_BT709HDTV,      /**< BT709 High Definition TV colorspace. */
    NPP_BT2020HDTV      /**< BT2020 High Definition TV colorspace. */
} NppiColorSpace;
