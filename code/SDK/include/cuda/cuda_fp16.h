...
* \endinternal
*/
__CUDA_FP16_DECL__ __half __NV_TL__ __NV_TL_BUILTIN__ __hfma(const __half a, const __half b, const __half c);
/**
* \ingroup CUDA_MATH__HALF_ARITHMETIC
* \brief Performs \p half fused multiply-add in round-to-nearest-even mode,
* with saturation to [0.0, 1.0].
...
* \endinternal
*/
__CUDA_FP16_DECL__ __half __NV_TL__ __NV_TL_BUILTIN__ __hfma_sat(const __half a, const __half b, const __half c);
#endif /* defined(__CUDACC__) && (!defined(__CUDA_ARCH__) || (__CUDA_ARCH__ >= 530)) || defined(_NVHPC_CUDA) */
...
* \endinternal
*/
__CUDA_FP16_DECL__ __half __NV_TL__ __NV_TL_BUILTIN__ __hfma_relu(const __half a, const __half b, const __half c);
#endif /* defined(__CUDACC__) && (!defined(__CUDA_ARCH__) || (__CUDA_ARCH__ >= 530)) || defined(_NVHPC_CUDA) */
/**
* \ingroup CUDA_MATH__HALF2_COMPARISON
...
public:
     ...
     */
    explicit __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const __nv_bfloat16 f); //forward declaration only, implemented in cuda_bf16.hpp
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const float f) { __x = __float2half(f).__x; }
    /**
     * \ingroup CUDA_MATH__HALF_MISC
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const double f) { __x = __double2half(f).__x; }
    /**
     * \ingroup CUDA_MATH__HALF_MISC
     ...
     * \see __float2half(float) for further details.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __half &operator=(const float f);
     ...
     * \see __double2half(double) for further details.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __half &operator=(const double f);
 ...
 */
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const short val) { __x = __short2half_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__HALF_MISC
     * Construct \p __half from \p unsigned \p short integer input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const unsigned short val) { __x = __ushort2half_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__HALF_MISC
     * Construct \p __half from \p int input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const int val) { __x = __int2half_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__HALF_MISC
     * Construct \p __half from \p unsigned \p int input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const unsigned int val) { __x = __uint2half_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__HALF_MISC
     * Construct \p __half from \p long input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const long val) {
...
#pragma warning (default: 4127)
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const unsigned long val) {
        /* Suppress VS warning: warning C4127: conditional expression is constant */
#if defined(_MSC_VER) && !defined(__CUDA_ARCH__)
#pragma warning (disable: 4127)
#endif /* _MSC_VER && !defined(__CUDA_ARCH__) */
...
#pragma warning (default: 4127)
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const long long val) { __x = __ll2half_rn(val).__x; }
    /**
     * \ingroup CUDA_MATH__HALF_MISC
     * Construct \p __half from \p unsigned \p long \p long input using default round-to-nearest-even rounding mode.
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ __NV_TL_BUILTIN__ __half(const unsigned long long val) { __x = __ull2half_rn(val).__x; }
     ...
     */
    __CUDA_HOSTDEVICE__ __NV_TL__ operator bool() const {
        return (__half_as_ushort(*this) & 0x7FFFU) != 0U;
    }
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_FP16_FORCEINLINE__ __NV_TL__ __half operator+(const __half &lh, const __half &rh);
/**
 * \ingroup CUDA_MATH__HALF_ARITHMETIC
 ...
 * \see __hadd(__half, __half)
 */
__CUDA_HOSTDEVICE__ __CUDA_FP16_FORCEINLINE__ __NV_TL__ __half &operator+=(__half &lh, const __half &rh);
/**
 * \ingroup CUDA_MATH__HALF_ARITHMETIC
 ...
 * \see __hadd(__half, __half)
 */
__CUDA_HOSTDEVICE__ __CUDA_FP16_FORCEINLINE__ __NV_TL__ __half &operator++(__half &h);
/**
 * \ingroup CUDA_MATH__HALF_ARITHMETIC
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_FP16_FORCEINLINE__ __NV_TL__ __half operator+(const __half &h);
/**
 * \ingroup CUDA_MATH__HALF_ARITHMETIC
 ...
 */
__CUDA_HOSTDEVICE__ __CUDA_FP16_FORCEINLINE__ __NV_TL__ bool operator==(const __half &lh, const __half &rh);
/**
 * \ingroup CUDA_MATH__HALF_COMPARISON
