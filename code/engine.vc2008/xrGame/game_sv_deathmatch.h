...
protected:
	...
	/////////////////////////////////////////////////////////////
	typedef xr_vector< xr_string > ANOMALIES; typedef ANOMALIES::iterator ANOMALIES_it;
	typedef xr_vector< ANOMALIES > ANOMALY_SETS; typedef ANOMALY_SETS::iterator ANOMALY_SETS_it;
	...
	typedef xr_vector< u16 > ANOMALIES_ID; typedef ANOMALIES_ID::iterator ANOMALIES_ID_it;
	typedef xr_vector< ANOMALIES_ID > ANOMALY_SETS_ID; typedef ANOMALY_SETS_ID::iterator ANOMALY_SETS_ID_it;
