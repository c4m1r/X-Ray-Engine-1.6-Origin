...
{
	typedef xr_map< AnsiString,PDomain > PDomainMap; typedef PDomainMap::iterator PDomainMapIt;
	typedef xr_map< AnsiString,PBool > PBoolMap; typedef PBoolMap::iterator PBoolMapIt;
	typedef xr_map< AnsiString,PFloat > PFloatMap; typedef PFloatMap::iterator PFloatMapIt;
    typedef xr_map< AnsiString,PInt > PIntMap; typedef PIntMap::iterator PIntMapIt;
	typedef xr_map< AnsiString,PVector > PVectorMap; typedef PVectorMap::iterator PVectorMapIt;
	...
	typedef xr_vector< SOrder > OrderVec; typedef OrderVec::iterator OrderVecIt;
    OrderVec		orders;
