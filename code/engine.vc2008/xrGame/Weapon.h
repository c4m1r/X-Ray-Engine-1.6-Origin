...
/*
	...
	typedef xr_vector< SScopes* > SCOPES_VECTOR; typedef SCOPES_VECTOR::iterator SCOPES_VECTOR_IT;
	SCOPES_VECTOR			m_scopes;

	u8						cur_scope;
*/

	typedef xr_vector< shared_str > SCOPES_VECTOR; typedef SCOPES_VECTOR::iterator SCOPES_VECTOR_IT;
	SCOPES_VECTOR			m_scopes;
	u8						m_cur_scope;
