...
private:
	struct STextureInfo{
        ...
        typedef xr_map< shared_str,SObjInfo > objinf_map; typedef objinf_map::iterator objinf_map_it;
        objinf_map			objects;
    ...
    typedef xr_set< STextureInfo > TISet; typedef TISet::iterator TISetIt;
    TISet		textures;
    struct SPairInfo{
    	xr_string			first;
    	xr_string			second;
    };
    typedef xr_vector< SPairInfo > PIVec; typedef PIVec::iterator PIVecIt;
	struct SObjectInfo{      
    ...
    typedef xr_set< SObjectInfo > OISet; typedef OISet::iterator OISetIt;
    OISet		objects;
public:    
...
protected:
    ...
    typedef xr_vector< SPixelDensityPair > PDVec; typedef PDVec::iterator PDVecIt;
    PDVec		pm_colors;
