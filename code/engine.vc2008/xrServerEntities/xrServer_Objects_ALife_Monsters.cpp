...
/*IC*/	void CSE_ALifeCreatureAbstract::set_health	(float /*const*/ health_value) // range fix
{
	VERIFY( !((get_killer_id() != u16(-1)) && (health_value > 0.f)) );
	fHealth = health_value;
}

/*IC*/	void CSE_ALifeCreatureAbstract::set_killer_id	(const ALife::_OBJECT_ID& killer_id)
{
