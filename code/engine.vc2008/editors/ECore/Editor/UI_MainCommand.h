...
typedef xr_vector< SESubCommand* > ESubCommandVec; typedef ESubCommandVec::iterator ESubCommandVecIt;
...
typedef xr_vector< SECommand* > ECommandVec; typedef ECommandVec::iterator ECommandVecIt;
